...
ch_appinfo(3193) > [SECURE_LOG] where = package_app_info.app_exec='/opt/usr/apps/org.example.basicui/bin/basicui' and package_app_info.app_disable IN ('false','False')
...
03-23 18:57:38.523+0900 W/CRASH_MANAGER( 6567): worker.c: worker_job(1189) > 11067536261731458727058
03-23 18:57:38.563+0900 D/AUL_AMD ( 2167): amd_request.c: __add_history_handler(247) > [SECURE_LOG] add rua history org.example.basicui /opt/usr/apps/org.example.basicui/bin/basicui
03-23 18:57:38.563+0900 D/RUA     ( 2167): rua.c: rua_add_history(179) > rua_add_history start
03-23 18:57:38.563+0900 D/RUA     ( 2167): rua.c: rua_add_history(247) > rua_add_history ok
03-23 18:57:38.563+0900 D/RESOURCED( 2337): proc-monitor.c: proc_dbus_proc_signal_handler(198) > [proc_dbus_proc_signal_handler,198] call proc_dbus_proc_signal_handler : pid = 2241, type = 0
03-23 18:57:38.563+0900 D/RESOURCED( 2337): proc-main.c: resourced_proc_status_change(555) > [SECURE_LOG] [resourced_proc_status_change,555] set foreground : 2241
03-23 18:57:38.563+0900 E/RESOURCED( 2337): proc-main.c: proc_update_process_state(233) > [proc_update_process_state,233] Current pid (2241) didn't have any process list
03-23 18:57:38.563+0900 D/RESOURCED( 2337): cpu.c: cpu_foreground_state(92) > [cpu_foreground_state,92] cpu_foreground_state : pid = 2241, appname = (null)
03-23 18:57:38.563+0900 D/RESOURCED( 2337): cgroup.c: cgroup_write_node(91) > [SECURE_LOG] [cgroup_write_node,91] cgroup_buf /sys/fs/cgroup/cpu/cgroup.procs, value 2241
03-23 18:57:38.573+0900 D/AUL_AMD ( 2167): amd_launch.c: __e17_status_handler(1911) > pid(2241) status(3)
03-23 18:57:38.573+0900 I/AUL_PAD ( 2189): sigchild.h: __launchpad_sig_child(142) > dead_pid = 6753 pgid = 6753
03-23 18:57:38.573+0900 I/AUL_PAD ( 2189): sigchild.h: __sigchild_action(123) > dead_pid(6753)
03-23 18:57:38.573+0900 D/AUL_PAD ( 2189): sigchild.h: __send_app_dead_signal(81) > send dead signal done
03-23 18:57:38.573+0900 I/AUL_PAD ( 2189): sigchild.h: __sigchild_action(129) > __send_app_dead_signal(0)
03-23 18:57:38.573+0900 I/AUL_PAD ( 2189): sigchild.h: __launchpad_sig_child(150) > after __sigchild_action
03-23 18:57:38.573+0900 I/AUL_AMD ( 2167): amd_main.c: __app_dead_handler(262) > __app_dead_handler, pid: 6753
03-23 18:57:38.573+0900 D/AUL_AMD ( 2167): amd_key.c: _unregister_key_event(161) > ===key stack===
03-23 18:57:38.573+0900 D/AUL     ( 2167): simple_util.c: __trm_app_info_send_socket(261) > __trm_app_info_send_socket
03-23 18:57:38.573+0900 E/AUL     ( 2167): simple_util.c: __trm_app_info_send_socket(264) > access
03-23 18:57:38.573+0900 D/STARTER ( 2234): starter_w.c: _w_app_dead_cb(183) > [STARTER/home/abuild/rpmbuild/BUILD/starter-0.5.52/src/starter_w.c:183:D] app dead cb call! (pid : 6753)
03-23 18:57:38.673+0900 E/W_HOME  ( 2241): main.c: _window_focus_in_cb(851) > win[25165827], ev->win[25165831]
03-23 18:57:38.673+0900 D/APPS    ( 2241): apps_main.c: _window_focus_in_cb(288) >  focus in
03-23 18:57:38.673+0900 E/W_HOME  ( 2241): noti_broker.c: noti_broker_event_fire_to_plugin(657) > (s_info.is_loaded == 0) -> noti_broker_event_fire_to_plugin() return
03-23 18:57:38.673+0900 D/APPS    ( 2241): apps_main.c: apps_main_resume(693) >  Resume starts
03-23 18:57:38.673+0900 D/APPS    ( 2241): scroller.c: _resume_result_cb(187) >  Activate the rotary events for apps
03-23 18:57:38.673+0900 E/efl-extension( 2241): efl_extension_rotary.c: eext_rotary_object_event_activated_set(301) > eext_rotary_object_event_activated_set : 0xb7b8bfb0, elm_scroller, _activated_obj : 0xb7b8bfb0, activated : 1
03-23 18:57:38.673+0900 D/APP_CORE( 2241): appcore-efl.c: __update_win(718) > [EVENT_TEST][EVENT] __update_win WIN:1800007 fully_obscured 0
03-23 18:57:38.673+0900 D/APP_CORE( 2241): appcore-efl.c: __visibility_cb(884) > bvisibility 1, b_active 0
03-23 18:57:38.673+0900 D/APP_CORE( 2241): appcore-efl.c: __visibility_cb(887) >  Go to Resume state
03-23 18:57:38.673+0900 D/APP_CORE( 2241): appcore-efl.c: __do_app(470) > [APP 2241] Event: RESUME State: PAUSED
03-23 18:57:38.673+0900 D/LAUNCH  ( 2241): appcore-efl.c: __do_app(557) > [w-home:Application:resume:start]
03-23 18:57:38.673+0900 D/APP_CORE( 2241): appcore-efl.c: __do_app(559) > [APP 2241] RESUME
03-23 18:57:38.673+0900 I/CAPI_APPFW_APPLICATION( 2241): app_main.c: _ui_app_appcore_resume(624) > app_appcore_resume
03-23 18:57:38.673+0900 D/W_HOME  ( 2241): main.c: _resume_cb(564) > Resumed
03-23 18:57:38.673+0900 D/APPS    ( 2241): apps_main.c: apps_main_is_visible(757) >  bShow:[1]
03-23 18:57:38.673+0900 E/W_HOME  ( 2241): main.c: _resume_cb(576) > Apps is showing
03-23 18:57:38.673+0900 D/LAUNCH  ( 2241): appcore-efl.c: __do_app(567) > [w-home:Application:resume:done]
03-23 18:57:38.673+0900 D/LAUNCH  ( 2241): appcore-efl.c: __do_app(569) > [w-home:Application:Launching:done]
03-23 18:57:38.673+0900 D/APP_CORE( 2241): appcore-efl.c: __trm_app_info_send_socket(230) > __trm_app_info_send_socket
03-23 18:57:38.673+0900 E/APP_CORE( 2241): appcore-efl.c: __trm_app_info_send_socket(233) > access
03-23 18:57:38.673+0900 D/W_HOME  ( 2241): main.c: _dead_cb(542) > PID(6753) is dead
03-23 18:57:38.673+0900 E/W_HOME  ( 2241): clock_shortcut.c: _shortcut_icon_owner_get(190) > (icon == NULL) -> _shortcut_icon_owner_get() return
03-23 18:57:38.713+0900 I/GESTURE ( 2052): gesture.c: GestureRecognize(2377) > [BackKey][F] Press touch outside 40 pixel area from upper vezel. 
03-23 18:57:38.773+0900 D/EFL     ( 2241): ecore_x<2241> ecore_x_events.c:531 _ecore_x_event_handle_button_press() ButtonEvent:press time=24409769 button=1
03-23 18:57:38.773+0900 D/APPS    ( 2241): scroller.c: _mouse_down_cb(100) >  Mouse is down [171,346]
03-23 18:57:38.773+0900 D/APPS    ( 2241): item.c: _down_cb(381) >  Down (basicui,0xb7c71a60) (171, 346), item pos(41,1,280,390)
03-23 18:57:38.773+0900 E/APPS    ( 2241): item.c: _down_cb(425) >  longpress edit mode disable
03-23 18:57:38.783+0900 W/APPS    ( 2241): item.c: _anim_item_pressed_cb(1046) >  item is pressed
03-23 18:57:38.833+0900 D/EFL     ( 2241): ecore_x<2241> ecore_x_events.c:683 _ecore_x_event_handle_button_release() ButtonEvent:release time=24409848 button=1
03-23 18:57:38.833+0900 D/APPS    ( 2241): scroller.c: _mouse_up_cb(111) >  Mouse is up [171,346]
03-23 18:57:38.833+0900 D/APPS    ( 2241): item.c: _up_cb(573) >  Up (basicui,0xb7c71a60) (171, 346), item pos(41,1,280,390)
03-23 18:57:38.833+0900 E/APPS    ( 2241): item.c: _clicked_cb(65) >  Clicked
03-23 18:57:38.833+0900 E/APPS    ( 2241): effect.c: apps_effect_play_sound(86) >  effect_info.sound_status: [0]
03-23 18:57:38.833+0900 D/APPS    ( 2241): item.c: _clicked_cb(95) >  item(rpm) launched to aul_launch
03-23 18:57:38.833+0900 D/APP_SVC ( 2241): appsvc.c: __set_bundle(161) > __set_bundle
03-23 18:57:38.833+0900 D/APP_SVC ( 2241): appsvc.c: __get_alias_appid(568) > [SECURE_LOG] alias_id : (null)
03-23 18:57:38.833+0900 D/APP_SVC ( 2241): appsvc.c: __set_bundle(161) > __set_bundle
03-23 18:57:38.833+0900 D/W_HOME  ( 2241): dbus_util.c: _dbus_method_async_call(141) > dbus_connection_send, ret=1
03-23 18:57:38.833+0900 D/W_HOME  ( 2241): dbus_util.c: home_dbus_cpu_booster_signal_send(278) > Sending cpu booster call:200 result:0
03-23 18:57:38.833+0900 D/APP_SVC ( 2241): appsvc.c: __run_svc_with_pkgname(237) > [SECURE_LOG] pkg_name : org.example.basicui - no result
03-23 18:57:38.833+0900 D/AUL     ( 2241): launch.c: app_request_to_launchpad(281) > [SECURE_LOG] launch request : org.example.basicui
03-23 18:57:38.833+0900 D/AUL     ( 2241): app_sock.c: __app_send_raw(265) > pid(-2) : cmd(0)
03-23 18:57:38.843+0900 D/AUL_AMD ( 2167): amd_request.c: __request_handler(495) > __request_handler: 0
03-23 18:57:38.843+0900 D/AUL_AMD ( 2167): amd_request.c: __request_handler(540) > launch a single-instance appid: org.example.basicui
03-23 18:57:38.843+0900 D/AUL_AMD ( 2167): amd_launch.c: _start_app(1479) > [SECURE_LOG] caller : org.tizen.w-home
03-23 18:57:38.843+0900 E/AUL_AMD ( 2167): amd_launch.c: invoke_dbus_method_sync(1190) > dbus_connection_send error(org.freedesktop.DBus.Error.ServiceUnknown:The name org.tizen.system.coord was not provided by any .service files)
03-23 18:57:38.843+0900 D/AUL_AMD ( 2167): amd_launch.c: _start_app(1690) > org.tizen.system.coord.rotation-Degree : -74
03-23 18:57:38.843+0900 D/AUL_AMD ( 2167): amd_launch.c: _start_app(1785) > process_pool: false
03-23 18:57:38.843+0900 D/AUL_AMD ( 2167): amd_launch.c: _start_app(1788) > h/w acceleration: SYS
03-23 18:57:38.843+0900 D/AUL_AMD ( 2167): amd_launch.c: _start_app(1790) > [SECURE_LOG] appid: org.example.basicui
03-23 18:57:38.843+0900 D/AUL_AMD ( 2167): amd_launch.c: __set_appinfo_for_launchpad(1950) > Add hwacc, taskmanage, app_path and pkg_type into bundle for sending those to launchpad.
03-23 18:57:38.843+0900 D/AUL     ( 2167): app_sock.c: __app_send_raw(265) > pid(-1) : cmd(0)
03-23 18:57:38.843+0900 D/AUL_PAD ( 2189): launchpad.c: __launchpad_main_loop(641) > [SECURE_LOG] pkg name : org.example.basicui
03-23 18:57:38.843+0900 D/AUL_PAD ( 2189): launchpad.c: __modify_bundle(380) > parsing app_path: No arguments
03-23 18:57:38.843+0900 D/AUL_PAD ( 2189): launchpad.c: __launchpad_main_loop(699) > [SECURE_LOG] ==> real launch pid : 6763 /opt/usr/apps/org.example.basicui/bin/basicui
03-23 18:57:38.843+0900 D/AUL_PAD ( 2189): launchpad.c: __send_result_to_caller(555) > -- now wait to change cmdline --
03-23 18:57:38.843+0900 D/AUL_PAD ( 6763): launchpad.c: __launchpad_main_loop(668) > lock up test log(no error) : fork done
03-23 18:57:38.843+0900 D/AUL_PAD ( 6763): launchpad.c: __launchpad_main_loop(679) > lock up test log(no error) : prepare exec - first done
03-23 18:57:38.843+0900 D/AUL_PAD ( 6763): launchpad.c: __prepare_exec(136) > [SECURE_LOG] pkg_name : org.example.basicui / pkg_type : rpm / app_path : /opt/usr/apps/org.example.basicui/bin/basicui 
03-23 18:57:38.853+0900 D/AUL_PAD ( 6763): launchpad.c: __launchpad_main_loop(693) > lock up test log(no error) : prepare exec - second done
03-23 18:57:38.853+0900 D/AUL_PAD ( 6763): launchpad.c: __real_launch(223) > [SECURE_LOG] input argument 0 : /opt/usr/apps/org.example.basicui/bin/basicui##
03-23 18:57:38.853+0900 D/AUL_PAD ( 6763): launchpad.c: __real_launch(223) > [SECURE_LOG] input argument 2 : __APP_SVC_OP_TYPE__##
03-23 18:57:38.853+0900 D/AUL_PAD ( 6763): launchpad.c: __real_launch(223) > [SECURE_LOG] input argument 4 : __APP_SVC_PKG_NAME__##
03-23 18:57:38.853+0900 D/AUL_PAD ( 6763): launchpad.c: __real_launch(223) > [SECURE_LOG] input argument 6 : __AUL_STARTTIME__##
03-23 18:57:38.853+0900 D/AUL_PAD ( 6763): launchpad.c: __real_launch(223) > [SECURE_LOG] input argument 8 : __AUL_CALLER_PID__##
03-23 18:57:38.853+0900 D/AUL_PAD ( 6763): launchpad.c: __real_launch(223) > [SECURE_LOG] input argument 10 : __AUL_CALLER_APPID__##
03-23 18:57:38.853+0900 D/LAUNCH  ( 6763): launchpad.c: __real_launch(229) > [SECURE_LOG] [/opt/usr/apps/org.example.basicui/bin/basicui:Platform:launchpad:done]
03-23 18:57:38.863+0900 I/efl-extension( 6763): efl_extension.c: eext_mod_init(39) > Init
03-23 18:57:38.863+0900 I/CAPI_APPFW_APPLICATION( 6763): app_main.c: ui_app_main(701) > app_efl_main
03-23 18:57:38.873+0900 D/LAUNCH  ( 6763): appcore-efl.c: appcore_efl_main(1571) > [basicui:Application:main:done]
03-23 18:57:38.883+0900 D/APP_CORE( 6763): appcore-efl.c: __before_loop(1017) > elm_config_preferred_engine_set is not called
03-23 18:57:38.893+0900 D/AUL     ( 6763): pkginfo.c: aul_app_get_pkgid_bypid(257) > [SECURE_LOG] appid for 6763 is org.example.basicui
03-23 18:57:38.893+0900 D/APP_CORE( 6763): appcore.c: appcore_init(532) > [SECURE_LOG] dir : /usr/apps/org.example.basicui/res/locale
03-23 18:57:38.893+0900 D/APP_CORE( 6763): appcore-i18n.c: update_region(71) > *****appcore setlocale=en_GB.UTF-8
03-23 18:57:38.893+0900 D/AUL     ( 6763): app_sock.c: __create_server_sock(136) > pg path - already exists
03-23 18:57:38.893+0900 D/LAUNCH  ( 6763): appcore-efl.c: __before_loop(1035) > [basicui:Platform:appcore_init:done]
03-23 18:57:38.893+0900 I/CAPI_APPFW_APPLICATION( 6763): app_main.c: _ui_app_appcore_create(559) > app_appcore_create
03-23 18:57:38.903+0900 E/EFL     ( 6763): eina_module<6763> eina_module.c:339 eina_module_load() could not dlopen("/opt/home/app/.edje/modules/elm/linux-gnu-i686-1.0.0/module.so", RTLD_NOW): /opt/home/app/.edje/modules/elm/linux-gnu-i686-1.0.0/module.so: cannot open shared object file: No such file or directory
03-23 18:57:38.923+0900 E/EFL     ( 6763): ecore_evas<6763> ecore_evas_extn.c:2169 ecore_evas_extn_plug_connect() Extn plug failed to connect:ipctype=0, svcname=elm_indicator_portrait, svcnum=0, svcsys=0
03-23 18:57:38.923+0900 E/EFL     ( 6763): elementary<6763> elc_naviframe.c:46 _nf_mod_init() _nf_mod_init initted 1
03-23 18:57:38.923+0900 E/EFL     ( 6763): eina_module<6763> eina_module.c:339 eina_module_load() could not dlopen("/opt/home/app/.elementary/modules/naviframe_effect/linux-gnu-i686-1.7.99/module.so", RTLD_NOW): /opt/home/app/.elementary/modules/naviframe_effect/linux-gnu-i686-1.7.99/module.so: cannot open shared object file: No such file or directory
03-23 18:57:38.933+0900 I/basicui ( 6763): started
03-23 18:57:38.933+0900 I/basicui ( 6763): listener
03-23 18:57:38.933+0900 D/LAUNCH  ( 6763): appcore-efl.c: __before_loop(1047) > [basicui:Application:create:done]
03-23 18:57:38.933+0900 D/APP_CORE( 6763): appcore-efl.c: __check_wm_rotation_support(752) > Disable window manager rotation
03-23 18:57:38.933+0900 D/APP_CORE( 6763): appcore.c: __aul_handler(423) > [APP 6763]     AUL event: AUL_START
03-23 18:57:38.933+0900 D/APP_CORE( 6763): appcore-efl.c: __do_app(470) > [APP 6763] Event: RESET State: CREATED
03-23 18:57:38.933+0900 D/APP_CORE( 6763): appcore-efl.c: __do_app(496) > [APP 6763] RESET
03-23 18:57:38.933+0900 D/LAUNCH  ( 6763): appcore-efl.c: __do_app(498) > [basicui:Application:reset:start]
03-23 18:57:38.933+0900 I/CAPI_APPFW_APPLICATION( 6763): app_main.c: _ui_app_appcore_reset(642) > app_appcore_reset
03-23 18:57:38.933+0900 D/LAUNCH  ( 6763): appcore-efl.c: __do_app(501) > [basicui:Application:reset:done]
03-23 18:57:38.933+0900 I/APP_CORE( 6763): appcore-efl.c: __do_app(507) > Legacy lifecycle: 0
03-23 18:57:38.933+0900 I/APP_CORE( 6763): appcore-efl.c: __do_app(509) > [APP 6763] Initial Launching, call the resume_cb
03-23 18:57:38.933+0900 I/CAPI_APPFW_APPLICATION( 6763): app_main.c: _ui_app_appcore_resume(624) > app_appcore_resume
03-23 18:57:38.933+0900 D/APP_CORE( 6763): appcore.c: __aul_handler(426) > [SECURE_LOG] caller_appid : org.tizen.w-home
03-23 18:57:38.943+0900 D/AUL_PAD ( 2189): sigchild.h: __signal_block_sigchld(230) > SIGCHLD blocked
03-23 18:57:38.943+0900 D/AUL_PAD ( 2189): sigchild.h: __send_app_launch_signal(112) > send launch signal done
03-23 18:57:38.943+0900 D/AUL_PAD ( 2189): sigchild.h: __signal_unblock_sigchld(242) > SIGCHLD unblocked
03-23 18:57:38.943+0900 D/AUL     ( 2167): simple_util.c: __trm_app_info_send_socket(261) > __trm_app_info_send_socket
03-23 18:57:38.943+0900 E/AUL     ( 2167): simple_util.c: __trm_app_info_send_socket(264) > access
03-23 18:57:38.943+0900 D/RESOURCED( 2337): proc-noti.c: recv_str(87) > [recv_str,87] str is null
03-23 18:57:38.943+0900 D/RESOURCED( 2337): proc-noti.c: process_message(169) > [process_message,169] process message caller pid 2167
03-23 18:57:38.943+0900 D/RESOURCED( 2337): proc-main.c: resourced_proc_action(669) > [SECURE_LOG] [resourced_proc_action,669] appid org.example.basicui, pid 6763, type 4 
03-23 18:57:38.943+0900 D/RESOURCED( 2337): proc-main.c: resourced_proc_status_change(570) > [SECURE_LOG] [resourced_proc_status_change,570] launch request org.example.basicui, 6763
03-23 18:57:38.943+0900 D/RESOURCED( 2337): proc-main.c: resourced_proc_status_change(572) > [SECURE_LOG] [resourced_proc_status_change,572] launch request org.example.basicui with pkgname
03-23 18:57:38.943+0900 E/RESOURCED( 2337): proc-main.c: resourced_proc_status_change(577) > [resourced_proc_status_change,577] available memory = 240
03-23 18:57:38.943+0900 D/RESOURCED( 2337): proc-noti.c: safe_write_int(178) > [safe_write_int,178] Response is not needed
03-23 18:57:38.943+0900 D/AUL     ( 2241): launch.c: app_request_to_launchpad(295) > launch request result : 6763
...
03-23 18:57:39.923+0900 W/CRASH_MANAGER( 6567): worker.c: worker_job(1189) > 1106763626173145872705
